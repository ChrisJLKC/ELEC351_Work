...
// No mutex's as one is sending data and one is recieving, so they will never race against each other, and the buffer helps
// to seperate those two threads so to make sure it doesn't race at all.
